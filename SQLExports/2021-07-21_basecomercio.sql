...
INSERT IGNORE INTO `articulos` (`id`, `id_categoria`, `nombre`, `precio`, `stock`, `url`, `detalle`) VALUES
...
INSERT IGNORE INTO `messages` (`id`, `id_articulo`, `id_user`, `message`, `date`) VALUES
...
INSERT IGNORE INTO `users` (`id`, `usuario`, `nombre`, `apellido`, `dni`, `condicion`, `password`, `fechaIng`, `activo`) VALUES
